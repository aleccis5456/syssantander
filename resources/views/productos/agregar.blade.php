...
<div class=" relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class=" w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-gray-50  dark:text-white dark:bg-gray-800">
            ...
            <div class="pt-4">
                <form action="{{ route('producto.buscarProducto') }}" method="get">
                    <div class="flex items-center">
                        <input name="q" value="{{ $q ?? '' }}" type="text" class="bg-gray-100 h-[35px] border border-gray-100 rounded-lg shadow-md focus:ring-gray-100 focus:border-gray-800">
